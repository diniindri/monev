                            ...
                            <tr>
                                ...
                                <td class="pb-0">
                                    <div class="btn-group btn-group-sm" role="group">
                                        ...
                                        <a href="<?= base_url('arsip/dnp/') . $r['id'] . 'a'; ?>" class="btn btn-sm btn-outline-secondary pt-0 pb-0">DNP</a>
                                        <a href="<?= base_url('arsip/coa/') . $r['id'] . '/a'; ?>" class="btn btn-sm btn-outline-secondary pt-0 pb-0">COA</a>
