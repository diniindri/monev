                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="pb-0 pr-0">
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="<?= base_url('pagu/index'); ?>" class="btn btn-sm btn-outline-secondary pt-0 pb-0">Detail</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="pb-0 pr-0">
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="<?= base_url('unit/index'); ?>" class="btn btn-sm btn-outline-secondary pt-0 pb-0">Detail</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="pb-0 pr-0">
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="<?= base_url('ppk/index'); ?>" class="btn btn-sm btn-outline-secondary pt-0 pb-0">Detail</a>
                                </div>
                            </td>
                        <tr>
                            <td>4</td>
                            ...
                            <td class="pb-0 pr-0">
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="<?= base_url('satker/index'); ?>" class="btn btn-sm btn-outline-secondary pt-0 pb-0">Detail</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="pb-0 pr-0">
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="<?= base_url('berkas/index'); ?>" class="btn btn-sm btn-outline-secondary pt-0 pb-0">Detail</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="pb-0 pr-0">
                                <div class="btn-group btn-group-sm" role="group">
                                    <a href="<?= base_url('nomor/index'); ?>" class="btn btn-sm btn-outline-secondary pt-0 pb-0">Detail</a>
                                </div>
                            </td>
                        </tr>
                        <td>13</td>
