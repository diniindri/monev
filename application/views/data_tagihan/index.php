                            ...
                            <tr>
                                ...
                                <td class="pb-0">
                                    <div class="btn-group btn-group-sm" role="group">
                                        ...
                                        <a href="<?= base_url('data-/index/') ?>" class="btn btn-sm btn-outline-secondary pt-0 pb-0">Detail</a>
                                        <a href="<?= base_url('pegawai/index/') ?>" class="btn btn-sm btn-outline-secondary pt-0 pb-0">Detail</a>
                                        <a href="<?= base_url('pegawai/index/') ?>" class="btn btn-sm btn-outline-secondary pt-0 pb-0">Detail</a>
                                    </div>
                                </td>
                            </tr>
